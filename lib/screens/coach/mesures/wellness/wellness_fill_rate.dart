...
class WellnessFillRate extends ConsumerStatefulWidget {
  @override
  ConsumerState<WellnessFillRate> createState() => _WellnessFillRateState();

  const WellnessFillRate({super.key});
}

class _WellnessFillRateState extends ConsumerState<WellnessFillRate> {
  @override
  Widget build(BuildContext context) {
    ...
    final stats = dataState.wellnessFillRate;
