...
class JoueurProfilScreenPrepa extends ConsumerStatefulWidget {
  final String joueurId;
  const JoueurProfilScreenPrepa({super.key, required this.joueurId});

  @override
  ConsumerState<JoueurProfilScreenPrepa> createState() =>
      _JoueurProfilScreenState();
}

class _JoueurProfilScreenState extends ConsumerState<JoueurProfilScreenPrepa> {
