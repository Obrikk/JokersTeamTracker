...
class RpeFillRate extends ConsumerStatefulWidget {
  @override
  ConsumerState<RpeFillRate> createState() => _RpeFillRateState();

  const RpeFillRate({super.key});
}

class _RpeFillRateState extends ConsumerState<RpeFillRate> {
  @override
  Widget build(BuildContext context) {
    ...
    final stats = dataState.rpeFillRate;
        ...
        child: Column(
          children: [
            Row(
              ...
              children: [
                Text('Rpe :', style: Theme.of(context).textTheme.displayLarge),
                IconButton(
