...
class PoidsFillRate extends ConsumerStatefulWidget {
  @override
  ConsumerState<PoidsFillRate> createState() => _PoidsFillRateState();

  const PoidsFillRate({super.key});
}

class _PoidsFillRateState extends ConsumerState<PoidsFillRate> {
  @override
  Widget build(BuildContext context) {
    ...
    final stats = dataState.poidsFillRate;
